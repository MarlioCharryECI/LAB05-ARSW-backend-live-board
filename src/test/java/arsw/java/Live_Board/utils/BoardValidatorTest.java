...
class BoardValidatorTest {
  ...
  void validateUserId_NullUserId_ShouldThrowException() {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> BoardValidator.validateUserId(null));
  ...
  void validateUserId_EmptyUserId_ShouldThrowException() {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> BoardValidator.validateUserId(""));
    assertEquals("userId no puede ser nulo o vacío", exception.getMessage());
  }
  ...
  void validateStroke_NullStroke_ShouldThrowException() {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> BoardValidator.validateStroke(null, 1));
  ...
  void validateStroke_NullPoints_ShouldThrowException() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> BoardValidator.validateStroke(stroke, 1));
  ...
  void validateStroke_NotEnoughPoints_ShouldThrowException() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> BoardValidator.validateStroke(stroke, 2));
