...
public class BoardController {
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Trazos obtenidos exitosamente")})
  @GetMapping("/board")
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "204", description = "Tablero borrado exitosamente")})
  @PostMapping("/clear")
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Cambios obtenidos exitosamente")})
  @GetMapping("/board/sync")
  public ResponseEntity<Map<String, Object>> syncBoard(@RequestParam(required = false) Long since) {
    ...
    logger.debug("Retornando {} trazos modificados", ((List<?>) syncData.get("strokes")).size());
